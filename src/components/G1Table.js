...
function G1Table({ g1s, loadG1s, loadG1sByCoupon, loadG1sByFloats, loadG1sByCouponsAndFloats }) {
  ...
  useLayoutEffect(() => {
    ...
    if(!searchA && !searchB){
      loadG1s()
        ...
        loadG1sByFloats(searchA);
        // console.log(searchA);  
      }
      else if (!searchA && searchB) {
        loadG1sByCoupon(searchB);
        // console.log(searchB); 
      }
      else {
        loadG1sByCouponsAndFloats(searchB, searchA)
        // console.log(searchB);
        // console.log(searchA);
      }
...

      {
        ...
        (<TableContainer component={Paper}>
          <Table className={classes.table} aria-label="simple table">
            <TableHead>
              <TableRow>
              <TableCell colSpan={2}> <b>G1s OCTOBER</b> </TableCell>
...
export default connect(mapStateToProps, mapDispatchToProps)(G1Table);