...
import { loadPlatinums } from '../store';
...
function PlatinumTable({ pools, loadPools, platinums, loadPlatinums, loadRowsByYear, bootstrap }) {
            ...
            <TableBody>
              ...
              {platinums.map((row) => (
                <TableRow key={row.cusip}>
                  ...
                  <TableCell align="right">{numberWithCommas(row.originalFace)}</TableCell>
...
export default connect(mapStateToProps, mapDispatchToProps)(PlatinumTable);